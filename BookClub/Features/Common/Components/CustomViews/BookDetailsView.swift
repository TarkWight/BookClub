...
struct BookDetailsView: View {
    ...
    private var headerImage: some View {
        ZStack(alignment: .topLeading) {
            ...
            BackButtonView(
                action: { print("router.navigateTo(.mainTab)") },
                color: .light
            )
            ...
            ActionButton(
                ...
                action: {
                    Task {
                        ...
                        print("router.navigateTo(.reader)")
                    }
                }
            )
...
extension BookDetailsView {
    fileprivate func progress() -> Double {
        let chapters = readingSession.fetchChapters()
    ...
    fileprivate func iconForChapter(_ chapter: BookChapter) -> Image {
    ...
    fileprivate func colorForChapter(_ chapter: BookChapter) -> Color {
        let currentChunk = readingSession.getCurrentChunkIndex()
    ...
    struct ActionButton: View {
        ...
        var body: some View {
            Button(action: action) {
                ...
                .foregroundColor(
                    isPrimary ? AppColors.white : AppColors.accentDark
                )
